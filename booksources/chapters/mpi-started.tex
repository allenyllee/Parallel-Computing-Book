...
%
In the \emph{MPI~3}%
\index{MPI!3!Fortran2008 interface} standard it is recommended that
...
\lstinline$MPI_Comm$, which were declared as \n{Integer}
previously, are now a Fortran \n{Type}.
%We will indicate this as needed.
...
\emph{Fortran90 bindings}\index{Fortran!90!bindings}:
%
...
\item The first argument is of type \lstinline$MPI_Comm$. This is not a C
...
\item Where C routines have \lstinline$MPI_Comm$ and \lstinline$MPI_Request$ and such
