...
as if in a parallel region. 
\begin{verbatim}
int i; double d;
#pragma omp threadprivate(i,d)
\end{verbatim}
In C/C++ the variables need to be file variables or be static;
in Fortran they need
to be declared at program level.
...
Threadprivate variables require \indextermtt{OMP_DYNAMIC} to be
switched off.
