...
There is an important difference with the above \indexmpishow{MPI_Type_indexed}:
...
the elements with \indexmpishow{MPI_Get_address}.

\mpiRoutineRef{MPI_Get_address}
