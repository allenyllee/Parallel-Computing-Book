...
\item MPI communication routines can only send multiples of a
  ...
  to use the \lstinline$MPI_BYTE$ data type, but this is not advisable.
...
%
\fverbatimsnippet{vector-f}
%
\pverbatimsnippet{vectorp}
...
\begin{exercise}
  ...
  \lstinline$MPI_Type_create_subarray$ to gather all data onto a root process.
...
%
\fverbatimsnippet{indexed-f}
%
\pverbatimsnippet{indexp}
...
%
\mpiRoutineRef{MPI_Type_create_hindexed_block}

There is an important difference with the above \lstinline$MPI_Type_indexed$:
