...
\indexmpishow{MPI_Type_struct} is deprecated with \indextermbus{MPI}{3}.)
%
\begin{figure}[ht]
...
(Alternatively, you could use \indexmpishow{MPI_Get_address}, which is
