...
Note that the \lstinline$MPI_Init$ call is one of the few that differs between C and Fortran:
...
For this reason, one can test where \lstinline$MPI_Init$ has been called with
%
\mpiRoutineRef{MPI_Initialized}
%

You can test whether \lstinline$MPI_Finalize$ has been called with
%
...
and \indextermtt{argv} for the following reason: the \lstinline$MPI_Init$ calls
