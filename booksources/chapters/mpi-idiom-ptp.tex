...
\begin{exercise}
  Implement the above averaging scheme using \lstinline$MPI_Sendrecv$.
\end{exercise}
...
\begin{exercise}
  Implement the above averaging scheme using \lstinline$MPI_Isend$ and \lstinline$MPI_Irecv$.
\end{exercise}
