...
\item It is also ordinarily not possible to send items of one type if they are
  not contiguous in memory. (You could send a contiguous memory area
...
The simplest derived type is the `contiguous' type: an array of items
