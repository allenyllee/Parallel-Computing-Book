...
You can delete a key with \indexmpiref{MPI_Info_delete}.
...
call\indexmpi{MPI_Comm_set_errhandler}:
\begin{lstlisting}
...
attributes through
\indexmpishow{MPI_Comm_get_attr}.
...
\cverbatimsnippet{mpit_init_q}

\cverbatimsnippet{mpit_list}
