...
Above you saw how to create an OpenMP parallel region,
for instance:
\begin{verbatim}
#pragma omp parallel
{
...
\end{verbatim}
  ...
  does not come up.)
\item In a parallel loop (section~\ref{sec:omp-for}, the loop variable
  is private, even though it may have been declared outside the
  parallel construct.
