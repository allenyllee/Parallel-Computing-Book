...
and
\indexpetscxref{MatAssemblyBegin}{MatAssemblyEnd}
%
...
routines such as 
\indexpetscref{MatGetRow}. Since PETSc is geared towards
...
Note that in a distributed running context you can only get local
elements this way. For a distributed version you need to take submatrices.

\Level 0 {Matrix operations}

\Level 1 {Matrix-vector operations}
...
\indexpetscdef{MatMultAdd} computes
$y\leftarrow z\leftarrow Ax +y $.

\Level 1 {Matrix-matrix operations}
