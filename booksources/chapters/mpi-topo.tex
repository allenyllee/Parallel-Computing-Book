...
The \n{reorder} parameter to \lstinline$MPI_Cart_create$
...
MPI's notion of \indextermbus{graph}{topology}, and the
\indextermsub{neighbourhood}{collectives}, offer an elegant way of
...
\begin{exercise}
  ...
  \lstinline$MPI_Dist_graph_create$. Use figure~\ref{fig:rightgraph} for inspiration.
\end{exercise}
