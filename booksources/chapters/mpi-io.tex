...
\begin{exercise}
  ...
  these buffers as a sequence to one file with \lstinline$MPI_File_write_at$.
\end{exercise}
...
\begin{exercise}
  ...
  but now use \lstinline$MPI_File_write$ and use \lstinline$MPI_File_set_view$ to set
