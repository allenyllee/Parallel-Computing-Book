...
%% is there a better section explaining master-worker?
...
\begin{figure}[ht]
\includegraphics[scale=.35]{mandel_serial}
...
\begin{figure}[ht]
\includegraphics[scale=.35]{mandel_bulk}
...
\begin{figure}[ht]
\includegraphics[scale=.35]{mandel_async}
