...
\lstset{emph={ %% MPI commands
    ...
    MPI_Recv,MPI_Irecv,MPI_Sendrecv,MPI_Sendrecv_replace,MPI_Mrecv,
    ...
    MPI_File_delete,MPI_File_set_size,MPI_File_get_size,MPI_File_preallocate,
    % one-sided
    ...
    MPI_Info_create,MPI_Info_set,MPI_Info_get,MPI_Info_free,MPI_Info_nkeys,    
  ...
  emph={[4] %% PETSc functions
    ...
    VecDot,VecScale,VecNorm,VecView,
