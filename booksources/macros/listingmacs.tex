...
\lstset{emph={ %%
    commands MPI_Init,MPI_Finalize,MPI_Abort,MPI_Get_processor_name,
  ...
  },emphstyle={\color{red!70!black}\bfseries}, emph={[2] %% constants
  ...
  },emphstyle={[2]\color{green!40!black}}, emph={[3] %% types
