...
\def\revdate{\escapechar-1\relax 1st edition 2015/6}%\ --\ \string\revision \revision}
\begin{lulu}
\def\publicdraft{}
\def\revdate{1st edition 2015/6}
\end{lulu}
...
\CHAPTER{MPI topic 2: Collectives}{mpi-collective}
\CHAPTER{MPI topic 3: Point-to-point}{mpi-ptp}
\CHAPTER{MPI topic 4: Data types}{mpi-data}
\CHAPTER{MPI topic 5: Communicators}{mpi-comm}
\CHAPTER{MPI topic 6: Process management}{mpi-proc}
\CHAPTER{MPI topic 7: One-sided communication}{mpi-onesided}
\CHAPTER{MPI topic 8: File I/O}{mpi-io}
\CHAPTER{MPI topic 9: Topologies}{mpi-topo}
\CHAPTER{MPI topic 10: Shared memory}{mpi-shared}
...
\CHAPTER{OpenMP topic 1: Parallel regions}{omp-parallel}
\CHAPTER{OpenMP topic 2: Loop parallelism}{omp-loop}
\CHAPTER{OpenMP topic 3: Work sharing}{omp-share}
\CHAPTER{OpenMP topic 4: Controlling thread data}{omp-data}
\CHAPTER{OpenMP topic 5: Reductions}{omp-reduction}
\CHAPTER{OpenMP topic 6: Synchronization}{omp-sync}
\CHAPTER{OpenMP topic 7: Tasks}{omp-task}
\CHAPTER{OpenMP topic 8: Affinity}{omp-affinity}
\CHAPTER{OpenMP tocic 9: Memory model}{omp-memory}
\CHAPTER{OpenMP tocic 10: SIMD processing}{omp-simd}
