...
\newenvironment{fortrannote}{\begin{quotation}\textbf{Fortran\ }}{\end{quotation}}
...
\def\indexclause#1{\texttt{#1}\index{omp!clause!#1|texttt}}
\def\indexclauseoption#1#2{\texttt{#2}\index{#1!#2|texttt}}
...
\CHAPTER{OmpMP Reference}{ompref}
