...
\lstset{emph={ %% commands
    MPI_Init,MPI_Finalize,MPI_Abort,MPI_Comm_size,MPI_Comm_rank,
    MPI_Comm_spawn,MPI_Comm_remote_size,MPI_Comm_get_parent,
    MPI_Allreduce,MPI_Reduce,MPI_Bcast,MPI_Gather,MPI_Allgather,MPI_Scan,MPI_Exscan,
    MPI_Send,MPI_Recv,MPI_Isend,MPI_Irecv,MPI_Ssend,MPI_Bsend,
    MPI_Send_init,MPI_Recv_init,MPI_Start_all,
    MPI_Wait,MPI_Waitall,MPI_Waitany,MPI_Test,MPI_Request_free,MPI_Request_get_status,
    MPI_Get_count,
    MPI_Buffer_attach,MPI_Buffer_detach,
    MPI_Type_commit,MPI_Type_free,MPI_Type_contiguous,MPI_Type_vector,
    MPI_Type_indexed,MPI_Type_create_hindexed,MPI_Type_create_subarray,
    ...
    MPI_Pack,MPI_Unpack,
    MPI_Win_create,MPI_Win_free,MPI_Alloc_mem,MPI_Win_fence,
  ...
  emph={[2] %% constants
    MPI_INFO_NULL,MPI_ARGV_NULL,MPI_PROC_NULL,
    MPI_IN_PLACE,MPI_REPLACE,
    MPI_STATUS_IGNORE,MPI_STATUSES_IGNORE,
    MPI_TAG,MPI_SOURCE,MPI_ANY_SOURCE,MPI_ANY_TAG,
    MPI_COMM_WORLD,
    MPI_SUM,MPI_MAX,
    MPI_INT,MPI_FLOAT,MPI_DOUBLE,MPI_REAL,MPI_CHAR,MPI_ADDRESS_KIND,
    MPI_LOCK_EXCLUSIVE,
  },emphstyle={[2]\color{green}\bfseries},
  emph={[3] %% types
    MPI_Aint,
    MPI_Status,MPI_Request,MPI_Comm,MPI_Datatype,
    MPI_Info,MPI_Win,
