...
\CHAPTER{Loop parallelism}{omp-loop}
\CHAPTER{Work sharing}{omp-share}
\CHAPTER{Controlling thread data}{omp-data}
\CHAPTER{Reductions}{omp-reduction}
\CHAPTER{Synchronization}{omp-sync}
\CHAPTER{Tasks}{omp-task}
