...
\lstset{emph={ %% commands
    ...
    MPI_Type_size,MPI_Type_get_extent,MPI_Type_get_true_extent,
    MPI_Pack,MPI_Unpack,
  ...
  emph={[2] %% constants
    ...
    MPI_TAG,MPI_SOURCE,MPI_PROC_NULL,MPI_ANY_SOURCE,MPI_ANY_TAG,
    MPI_COMM_WORLD,
    MPI_SUM,MPI_MAX,
    MPI_INT,MPI_FLOAT,MPI_REAL,MPI_CHAR,MPI_ADDRESS_KIND,
    MPI_LOCK_EXCLUSIVE,
