...
\newcommand\verbatimsnippet[1]{\verbatiminput{code/snippets/#1}}
...
\newcommand\commandref[1]{\label{#1}
  \begin{quotation}
    \small\sl\noindent The reference for the commands introduced here
    can be found in section~\ref{#1-ref}.
  \end{quotation}}
\newcommand\commandreflabel[1]{\label{#1-ref}
  \begin{quotation}
