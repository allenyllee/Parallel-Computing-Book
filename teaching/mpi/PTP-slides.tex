...
\begin{frame}[containsverbatim]{Overview}
  ...
  \item Mention of \indexmpishow{MPI_Test}, \indexmpishow{MPI_Bsend}\n{/Ssend/Rsend}.
  \end{itemize}
\end{frame}
...
\frame[containsverbatim,label=send]{\mpiRoutineRef{MPI_Send}}
\frame[containsverbatim,label=recv]{\mpiRoutineRef{MPI_Recv}}
