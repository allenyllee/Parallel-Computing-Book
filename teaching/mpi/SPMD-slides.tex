...
\frame[containsverbatim]{\mpiRoutineRef{MPI_Comm_size}}
\frame[containsverbatim]{\mpiRoutineRef{MPI_Comm_rank}}
...
\frame[containsverbatim]{\mpiRoutineRef{MPI_Get_processor_name}}
