...
\begin{frame}[containsverbatim]{Overview}
  ...
  \item \indexmpishow{MPI_Win_post}\n{/wait/start/complete}
...
\frame[containsverbatim]{\footnotesize \mpiRoutineRef{MPI_Put}}
...
\frame[containsverbatim]{\footnotesize \mpiRoutineRef{MPI_Get}}
\frame[containsverbatim]{\footnotesize \mpiRoutineRef{MPI_Accumulate}}
