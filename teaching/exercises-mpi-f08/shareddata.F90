...
Program SharedData
  ...
  ! window stuff
  type(MPI_Win) :: the_window,node_window
  ...
  print '("Proc",x,i0,x,"out of",x,i0)', procno,nprocs
...
#define REFVAL 3.14
  ...
  !!
  call MPI_Sizeof(shared_value,window_elt_size)
...
!!!! your code here !!!!
  ...
  !! no such thing  call f_c_pointer(win0_addr,win0_ptr)
  ...
  check_val = c_contents(win0_addr)
